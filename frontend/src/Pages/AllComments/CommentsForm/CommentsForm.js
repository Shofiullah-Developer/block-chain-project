...
const CommentsForm = () => {
    ...
    useEffect(() => {
        const uri = `https://floating-hollows-01861.herokuapp.com/allitems/${itemId}`;
        console.log(uri)
        fetch(uri)
            .then(res => res.json())
    ...
    const onSubmit = data => {
        ...
        axios.post('https://floating-hollows-01861.herokuapp.com/allitems/comments', newData)
            .then(res => {
                // console.log(res);
    ...
    useEffect(() => {
        fetch('https://floating-hollows-01861.herokuapp.com/allitems/comments/all')
            .then(res => res.json())
