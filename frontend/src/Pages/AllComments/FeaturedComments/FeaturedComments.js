...
const FeaturedComments = () => {
    ...
    return (
        <div style={{ minHeight: '100vh' }} className='py-5 bannerStyle2'>
            <Container className='pt-3'>
                <h2 className="App fw-bold pb-5" style={{ color: 'white' }}>Featured Assets </h2>
                            ...
                            >
                                <Card style={{ backgroundColor: '#0D0B0B', borderRadius: '5px' }}>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Title style={{ color: 'white' }} className='my-3'>{item.name}</Card.Title>
