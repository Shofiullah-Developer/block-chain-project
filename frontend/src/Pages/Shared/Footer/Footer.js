...
const Footer = () => {
    return (
        <div className="footerCover pt-5 pb-3">
            <Container >
                <Row className="row gy-4">
                    <Col xs={12} sm={12} md={4}>
                        <div className="footerLink">
                            <img src={brandlogo} alt="" width="60%" />
                            <p style={{ color: 'gray', textAlign: 'start', width: '75%' }}>Creating and minting NFTs in the Easiest and most efficient way.</p>
                        </div>
                    </Col>
                    <Col xs={6} sm={6} md={2} className="d-flex justify-content-sm-start justify-content-md-center">
                        <div className="footerLink">
                            ...
                            <p className="link">Emport / Export</p>
